...
void testType13() {
  ...
  bool seeDetails = false;
  {
    ...
    var fileOpen = createFile('type13_number1SumNumber2');
    fileOpen.writeln(
    ...
    fileOpen.close();
    fileOpen = createFile('type13_number1SubNumber2');
    fileOpen.writeln(
    ...
    fileOpen.close();
    fileOpen = createFile('type13_number1ProdNumber2');
    fileOpen.writeln(
    ...
    fileOpen.close();
    fileOpen = createFile('type13_number1DivNumber2');
    fileOpen.writeln(
