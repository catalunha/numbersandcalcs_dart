...
void testType15() {
  ...
  bool seeDetails = false;
  {
    ...
    var fileOpen = createFile('type15_number1SumNumber2');
    fileOpen.writeln(
    ...
    fileOpen.close();
    fileOpen = createFile('type15_number1SubNumber2');
    fileOpen.writeln(
    ...
    fileOpen.close();
    fileOpen = createFile('type15_number1ProdNumber2');
    fileOpen.writeln(
    ...
    fileOpen.close();
    fileOpen = createFile('type15_number1DivNumber2');
    fileOpen.writeln(
