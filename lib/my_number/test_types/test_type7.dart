...
void testType7() {
  ...
  bool seeDetails = false;
  {
    ...
    MyNumberSeed seed2 = MyNumberSeed(
      type: NumberQType.fraction,
      signalList: [NumberQSignal.positive, NumberQSignal.negative],
      fractionNumList: [1, 2, 3, 4, 5, 6, 7, 8, 9],
      fractionDenList: [1, 2, 3, 4, 5, 6, 7, 8, 9],
    );
    // print('seed2: $seed2');
    ...
    var fileOpen = createFile('type7_number1SumNumber2');
    fileOpen.writeln(
    ...
    fileOpen.close();
    fileOpen = createFile('type7_number1SubNumber2');
    fileOpen.writeln(
    ...
    fileOpen.close();
    fileOpen = createFile('type7_number1ProdNumber2');
    fileOpen.writeln(
    ...
    fileOpen.close();
    fileOpen = createFile('type7_number1DivNumber2');
    fileOpen.writeln(
